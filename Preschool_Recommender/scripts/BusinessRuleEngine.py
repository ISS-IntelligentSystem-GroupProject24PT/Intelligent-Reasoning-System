...
class BusinessRulesEngine:
    ...
    def __init__(self):
        ...
        user_input_file = os.path.join(self.INPUT_DIRECTORY_NAME, self.USER_INPUT_FILE)
        ...
        user_sunday_pick_up = ''  # user_input['user_sunday_pick_up']
        ...
        self.user_fees_sc_infant_care = 0  # user_fees_sc_infant_care = user_input['User_Preferred_Fees_SC_Infant_Care']
        self.user_fees_sc_playgroup = 0
        self.user_fees_sc_nursery = 1000
        self.user_fees_sc_kindergarten = 0
        self.user_fees_pr_infant_care = 0
        self.user_fees_pr_playgroup = 0
        self.user_fees_pr_nursery = 0
        self.user_fees_pr_kindergarten = 0
