...
programme = {
    ...
    "moral education": [
        "moral education", "character education", "ethics", "moral development", "values",
        "social-emotional"
    ],
    "motor skill development": [
        "motor skill development", "fine motor skills", "gross motor skills",
        "physical education", "sports", "physical", "motor", "sensory"
    ],
    "music": [
        "music", "speech and drama", "musical instruments", "singing", "songs", "movement",
        "arts"
    ],
    "nature": [
        "nature", "outdoor", 
    ...
    "numeracy": [
        "numeracy", "counting", "mathematics", "numbers", "numerical skills"
    ],
    "problem-solving skills": [
        "problem-solving skills", "critical thinking", "logical reasoning", "problem-solving",
        "critical", "thinking", "logic"
    ],
    "project work": [
        "project work", "creative projects", "inquiry-based learning", "interdisciplinary learning",
    ...
    "sensory play": [
        "sensory play", "sensory", "sensory integration", "sensory processing",
        "sensory stimulation", "exploration", "discovery"
    ],
    ...
    "sports": [
        "sports", "athletics", "fitness", "physical education", "sports skills", "physical",
        "fitness", "movement"
    ]
}
...
levels =  {
    "infant_care":[
        'baby', 'baby and child care', 'baby and toddler care', 'baby care', 'baby class', 
        'baby development', 'baby learning', 'baby nursery', 'baby-sitting', 'baby_care', 
        'caregiving', 'child care', 'child development', 'child-minding', 
        'developmental activities', 'developmental care', 'early childhood care', 
        'early childhood education', 'early learning', 'early years', 'early years care', 
        'early years development', 'early years education', 'early_childhood_education', 
        'early_years_education', 'infant', 'infant and toddler care', 'infant class', 
        ...
        'motor skills development', 'neonatal care', 'nurturing care', 'pediatric care', 
        'young child care', 'young infant care']
    ,
    "playgroup" :[
...
excel_file = './resources/SchoolPages/SchoolPage_Website_Links/Preschool_List_Txt_File_Address_Full_bk20240402.csv'
