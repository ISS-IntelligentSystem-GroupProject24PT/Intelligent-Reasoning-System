...
TEMP_FILES_DIRECTORY_NAME = "GoogleMaps_Search_Temp_Files"
MAIN_FILES_DIRECTORY_NAME = "GoogleMaps_Search_Main_Files"
ARCHIVES_DIRECTORY_NAME = "GoogleMaps_Search_Archives"

REFRESH_MAIN_FILES_DIRECTORY_NAME = "GoogleMaps_Refresh_Main_Files"
            ...
            if (df_link_results['Preschool_Name'] == preschool).any():
                ...
                if 'search' in websites:
                    ...
                    try:
                        ...
                        df_review = pd.concat(objs=[df_review, new_row], ignore_index=True)
